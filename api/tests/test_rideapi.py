...
class TestRide(unittest.TestCase):
    ...
    def test_login_invalid_credentials(self):
        """method tests login given wrong credentials"""
    ...
    def test_post_ride_offer(self):
        ...
        post_ride_response = helpers.post_ride_offer(self, data["auth_token"], "massaka",
                                                     "mbale", "14/06/2018", "13:00", 3, "This is just a sample request")
    ...
    def test_single_ride(self):
        ...
        ride_response = helpers.post_ride_offer(self, data["auth_token"], "masaka", "mbale",
                                                "14/06/2018", "13:00", 3, "This is just a sample request")
    ...
    def test_send_ride_request(self): 
        ...
        ride_response = helpers.post_ride_offer(self, user1_data["auth_token"], "masaka", "mbale", "14/06/2018", "13:00",
    ...
    def test_request_ride_wrong_authentication_code(self):
        ...
        # create ride using user1's token
        ride_response = helpers.post_ride_offer(self, user_data["auth_token"], "masaka", "mbale", "14/06/2018", "13:00", 3,
    ...
    def test_get_my_trips(self):
        ...
        # create ride using user1's token
        helpers.post_ride_offer(self, user1_data["auth_token"], "masaka", "mbale", "14/06/2018",
                                "13:00", 3, "This is just a sample request")
        helpers.post_ride_offer(self, user1_data["auth_token"], "kabale", "tororo", "14/06/2018",
                                "13:00", 3, "This is just a sample request")
        ...
        helpers.request_ride_join(self, ride3_data["ride"]["id"], user1_data["auth_token"])
